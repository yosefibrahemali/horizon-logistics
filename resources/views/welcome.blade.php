...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
            ...
            <!-- Include the custom elements library -->
    ...
    <div class="bg-gray">
        <header class="absolute inset-x-0 top-0 z-50">
            ...
            <div class="flex items-center lg:flex-1">
                <a href="#" class="flex items-center gap-2 -m-1.5 p-1.5">
                    <img src="{{ asset('logo-dark.png') }}" alt="Horizon Logo" class="h-12 w-auto" />
                    <span class="text-xl font-bold text-red-900">Horizon</span>
                </a>
            </div>
        ...
        <div  class="bg-gray-900">
            <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
                ...
                <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                    <h2 class="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl"> منصة موحدة لإدارة الشحنات والتسويات المالية لشركات التوصيل</h2>
                    <p class="mt-6 text-lg/8 text-pretty text-gray-300">  وفر وقتك وقلل التكاليف! مع منصتنا يمكنك إدارة شحناتك وسائقيك، متابعة عمليات الدفع الإلكتروني، 
         والحصول على تقارير تسوية مالية دقيقة وشفافة — كل هذا من لوحة تحكم واحدة.</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                    <a href="user-dashboard/register" class="rounded-md bg-gray-700 px-3.5 py-2.5 text-sm font-semibold text-white inset-ring inset-ring-white/5 hover:bg-gray-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"> جرّب مجانًا </a>
                    
                    </div>
                </div>
                <div class="relative mt-16 h-80 lg:mt-8">
                    <img width="450" height="1080" src="{{asset('screenshot-test.png')}}" alt="App screenshot" class="absolute top-0 left-0 w-228 max-w-none rounded-md bg-white/5 ring-1 ring-white/10" />
                </div>
                </div>
            </div>
        </div>
        <div class="relative isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div class="mx-auto max-w-4xl text-center">
                <h2 class="text-base/7 font-semibold text-indigo-400">الأسعار</h2>
                <p class="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl"> خطط بسيطة وشفافة</p>
            </div>
            <p class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">اختر الخطة المناسبة لشركتك، وابدأ خلال دقائق. لا توجد تكاليف مخفية.</p>
            <div class="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
                ...
                <h3 id="tier-hobby" class="text-base/7 font-semibold text-indigo-400">الخطة الأساسية (Starter)</h3>
                <p class="mt-4 flex items-baseline gap-x-2">
                    <span class="text-5xl font-semibold tracking-tight text-white">400د.ل</span>
                    <span class="text-base text-gray-400">/شهريًا</span>
                </p>
                <p class="mt-6 text-base/7 text-gray-300">مناسبة للشركات الناشئة.</p>
                <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
                    ...
                    نسبة 4% على المدفوعات الإلكترونية
                    </li>
                     <li class="flex gap-x-3">
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-400">
                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                    </svg>
                    إدارة متقدمة للسائقين
                    </li>
                    <li class="flex gap-x-3">
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-400">
                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                ...
                <a href="/user-dashboard/register" aria-describedby="tier-hobby" class="mt-8 block rounded-md bg-white/10 px-3.5 py-2.5 text-center text-sm font-semibold text-white inset-ring inset-ring-white/5 hover:bg-white/20 focus-visible:outline-2 focus-visible:outline-offset-2  focus-visible:outline-white/75 sm:mt-10">ابدأ الفترة المجانية الآن</a>
                </div>
                <div class="relative rounded-3xl bg-gray-800 p-8 ring-1 ring-white/10 sm:p-10">
                <h3 id="tier-enterprise" class="text-base/7 font-semibold text-indigo-400">الخطة المتقدمة (Professional)</h3>
                <p class="mt-4 flex items-baseline gap-x-2">
                    <span class="text-5xl font-semibold tracking-tight text-white">2000د.ل</span>
                    <span class="text-base text-gray-400">/شهريًا</span>
                </p>
                <p class="mt-6 text-base/7 text-gray-300">مثالية للشركات المتوسطة والكبيرة.</p>
                <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
                    <li class="flex gap-x-3">
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-400">
                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                ...
                <a href="/user-dashboard/register" aria-describedby="tier-enterprise" class="mt-8 block rounded-md bg-indigo-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 sm:mt-10">ابدأ الفترة المجانية الآن</a>
                
                </div>

                
                 <div class="rounded-3xl rounded-t-3xl bg-white/2.5 p-8 ring-1 ring-white/10 sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-tr-none lg:rounded-bl-3xl">
                <h3 id="tier-hobby" class="text-base/7 font-semibold text-indigo-400">الخطة الخاصة (Enterprise)</h3>
                <p class="mt-4 flex items-baseline gap-x-2">
                    <span class="text-5xl font-semibold tracking-tight text-white">تفاوضي –  يبدأ من   2500د.ل</span>
                    <span class="text-base text-gray-400">/شهريًا</span>
                </p>
                <p class="mt-6 text-base/7 text-gray-300">لشركات التوصيل الكبيرة والمتاجر الإلكترونية الكبرى.</p>
                <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
                    <li class="flex gap-x-3">
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-400">
                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                    ...
                    نسبة 2% على المدفوعات الإلكترونية
                    </li>
                     <li class="flex gap-x-3">
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-400">
                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
            ...
            {{-- <div class="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8" id="contact">
